                ...
                <div>
                  {uploadedFileList.map(
                    (file: FileDetails, fileIndex: number) => (
                      <div
                        className="grid grid-cols-12 file-list-main rounded-lg border-none p-[18px] items-center"
                        key={fileIndex}
                      >
                        ...
                        /> */}
                          ...
                          <div className="file-list-item xl:col-span-2 lg:col-span-3 sm:col-span-2 col-span-2">{file.size}</div>
                   

                        {/* dropdown start */}

                       
                        <div className="file-list-item xl:col-span-2 lg:col-span-3 sm:col-span-2 col-span-4">
                          ...
                          {/* dropdown end*/}
                          {/* close button */}
                          <div className="file-list-item col-span-1 my-auto ms-auto">
                            <svg
                              onClick={() =>
